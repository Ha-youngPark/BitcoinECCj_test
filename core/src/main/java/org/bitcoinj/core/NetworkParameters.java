...
public abstract class NetworkParameters {
    ...
    public static final int TARGET_TIMESPAN = 14 * 24 * 60 * 60;  // 1 hour per difficulty cycle, on average.
    public static final int TARGET_SPACING = 10 * 60;  // 1 minutes per block.
